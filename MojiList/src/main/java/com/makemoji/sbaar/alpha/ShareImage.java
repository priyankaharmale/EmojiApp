...
public class ShareImage extends AsyncTask<Void, Void, File> {
    ...
    public ShareImage(Context context, String gifUrl) {
    ...
    public void onPreExecute() {
        ...
        dialog.setMessage("preparing image to share ...");
    ...
    protected File doInBackground(Void... arg0) {
        try {
            ...
            if (responseCode == HttpURLConnection.HTTP_OK) {
                ...
                File file = new File(downloadDir, "image-" + System.currentTimeMillis() + ".png");
